...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HappyMood happyMood = new HappyMood();        // default date (now)
        SadMood sadMood = new SadMood(new Date());    // date passed in
        ...
        for (Mood mood : moodList) {
            System.out.println("Mood: " + mood.getMoodString() + " at " + mood.getDate());
        }
